...
// window.onload : 해당 문서 로딩되고나서 바로 실행할 함수 지정하는 구문
...
window.onload = function(){
    ...
    console.log(this.str3);   // undefined (정의되어있지 않다는 소리)
...
function typeTest(){
    ...
    var name = "홍길동"; // '홍길동' //String
    var age = 20;       // number
    var check = true;   // boolean
    var hobby = ["영화", "음악", "낮잠"]; // 배열을 담아도 object자료형
    ...
    var testFn = function(){    //익명함수(이름이없는 함수)
        alert("function자료형");
    };  //function
    ...
    var divEl = document.getElementById("area1")    // object
